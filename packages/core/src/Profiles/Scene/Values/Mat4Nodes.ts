...
export const Column4ToMat4 = makeFunctionDesc({
...
export const MultiplyByScalar = makeFunctionDesc({
...
export const Adjoint = makeFunctionDesc({
...
export const Mat3ToMat4 = makeFunctionDesc({
...
export const Scale3ToMat4 = makeFunctionDesc({
...
export const Translate3ToMat4 = makeFunctionDesc({
...
export const QuatToMat4 = makeFunctionDesc({
...
export const EulerToMat4 = makeFunctionDesc({
...
export const Translate = makeFunctionDesc({
...
export const RotateByQuat = makeFunctionDesc({
...
export const RotateByEuler = makeFunctionDesc({
...
export const TransformPoint3 = makeFunctionDesc({
...
export const TransformNormal3 = makeFunctionDesc({
...
export const LookAt = makeFunctionDesc({
