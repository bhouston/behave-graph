import * as flashSuzanneJson from '../../../../../examples/three-viewer/public/graphs/scene/actions/FlashSuzanne.json';
import * as hierarchyJson from '../../../../../examples/three-viewer/public/graphs/scene/actions/Hierarchy.json';
import * as spinningSuzanneJson from '../../../../../examples/three-viewer/public/graphs/scene/actions/SpinningSuzanne.json';
