...
export default function registerGenericNodes(registry: GraphTypeRegistry) {
  ...
  registry.registerNodeType('logic/booleanConstant', () => new UnaryOp<boolean, boolean>('logic/booleanConstant', (a) => (a)));
  registry.registerNodeType('logic/numberConstant', () => new UnaryOp<number, number>('logic/numberConstant', (a) => (a)));
  registry.registerNodeType('logic/stringConstant', () => new UnaryOp<string, string>('logic/stringConstant', (a) => (a)));

  // logic: boolean logic

  registry.registerNodeType('logic/booleanNot', () => new UnaryOp<boolean, boolean>('logic/booleanNot', (a) => (!a)));
  ...
  registry.registerNodeType('logic/numberNegate', () => new UnaryOp<number, number>('logic/numberNegate', (a) => (-a)));
  registry.registerNodeType('logic/numberSqrt', () => new UnaryOp<number, number>('logic/numberSqrt', (a) => (Math.sqrt(a))));

  // logic: exponential

  registry.registerNodeType('logic/numberE', () => new NullaryOp<number>('logic/numberSign', () => (Math.E)));
  registry.registerNodeType('logic/numberExp', () => new UnaryOp<number, number>('logic/numberExp', (a) => (Math.exp(a))));
  registry.registerNodeType('logic/numberLog', () => new UnaryOp<number, number>('logic/numberLog', (a) => (Math.log(a))));
  registry.registerNodeType('logic/numberLog2', () => new UnaryOp<number, number>('logic/numberLog2', (a) => (Math.log2(a))));
  registry.registerNodeType('logic/numberLog10', () => new UnaryOp<number, number>('logic/numberLog10', (a) => (Math.log10(a))));

  // logic: trigonometry

  registry.registerNodeType('logic/numberPi', () => new NullaryOp<number>('logic/numberNegate', () => (Math.PI)));
  registry.registerNodeType('logic/numberSin', () => new UnaryOp<number, number>('logic/numberSin', (a) => (Math.sin(a))));
  registry.registerNodeType('logic/numberAsin', () => new UnaryOp<number, number>('logic/numberSin', (a) => (Math.asin(a))));
  registry.registerNodeType('logic/numberCos', () => new UnaryOp<number, number>('logic/numberCos', (a) => (Math.cos(a))));
  registry.registerNodeType('logic/numberAcos', () => new UnaryOp<number, number>('logic/numberCos', (a) => (Math.acos(a))));
  registry.registerNodeType('logic/numberTan', () => new UnaryOp<number, number>('logic/numberTan', (a) => (Math.tan(a))));
  registry.registerNodeType('logic/numberAtan', () => new UnaryOp<number, number>('logic/numberTan', (a) => (Math.atan(a))));
  ...
  registry.registerNodeType('logic/numberSign', () => new UnaryOp<number, number>('logic/numberSign', (a) => (Math.sign(a))));
  registry.registerNodeType('logic/numberAbs', () => new UnaryOp<number, number>('logic/numberAbs', (a) => (Math.abs(a))));
  registry.registerNodeType('logic/numberFloor', () => new UnaryOp<number, number>('logic/numberFloor', (a) => (Math.floor(a))));
  registry.registerNodeType('logic/numberCeil', () => new UnaryOp<number, number>('logic/numberCeil', (a) => (Math.ceil(a))));
  registry.registerNodeType('logic/numberRound', () => new UnaryOp<number, number>('logic/numberCeil', (a) => (Math.round(a))));
  registry.registerNodeType('logic/numberTrunc', () => new UnaryOp<number, number>('logic/numberTrunc', (a) => (Math.trunc(a))));
  ...
  registry.registerNodeType('logic/numberIsNan', () => new UnaryOp<number, boolean>('logic/numberIsNan', (a) => (Number.isNaN(a))));
  registry.registerNodeType('logic/numberIsInf', () => new UnaryOp<number, boolean>('logic/numberIsInf', (a) => ((!Number.isFinite(a)) && !Number.isNaN(a))));
  ...
  registry.registerNodeType('logic/numberToString', () => new UnaryOp<number, string>('logic/numberToString', (a) => (a.toString())));
  registry.registerNodeType('logic/stringLength', () => new UnaryOp<string, number>('logic/stringLength', (a) => (a.length)));
