...
import * as colorJson from '../../../graphs/scene/math/Color.json';
import * as eulerJson from '../../../graphs/scene/math/Euler.json';
import * as quaternionJson from '../../../graphs/scene/math/Quaternion.json';
import * as vector2Json from '../../../graphs/scene/math/Vector2.json';
import * as vector3Json from '../../../graphs/scene/math/Vector3.json';
import * as vector4Json from '../../../graphs/scene/math/Vector4.json';
